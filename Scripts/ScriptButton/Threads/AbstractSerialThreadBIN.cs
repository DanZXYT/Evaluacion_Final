 ...
 * versions.
 */
public abstract class AbstractSerialThreadBIN
{
    ...
    // ------------------------------------------------------------------------
    public AbstractSerialThreadBIN(string portName,
                                int baudRate,
            ...
            while (!IsStopRequested())
            {
                ...
                catch (Exception ioe)
                {
                    ...
                    if (enqueueStatusMessages)
                        inputQueue.Enqueue(OpenASCII.SERIAL_DEVICE_DISCONNECTED);
    ...
    private void AttemptConnection()
    {
        ...
        if (enqueueStatusMessages)
            inputQueue.Enqueue(OpenASCII.SERIAL_DEVICE_CONNECTED);
    }
